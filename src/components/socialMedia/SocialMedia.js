  ...
  return (
    <div className="social-media-div">
      ...
      {socialMediaLinks.qqmail ? (
        <a href={`mailto:${socialMediaLinks.qqmail}`} className="icon-button qq" target="_blank" rel="noopener noreferrer">
      ...
      {socialMediaLinks.npm ? (
        <a href={socialMediaLinks.npm} className="icon-button npm" target="_blank" rel="noopener noreferrer">
